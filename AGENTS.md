# LearnedCooperation Agent Instructions
...
- Prefer running scripts and checks from repo root:
  - `/home/doesburg/Projects/LearnedCooperation`

## Cross-Repo Mapping

- This repository (`LearnedCooperation`) contains the canonical Python implementation for the code-backed learned-cooperation repeated Prisoner's Dilemma experiment.
...
- Required mapping:
  - `LearnedCooperation/` in this repo <-> `docs/learned-cooperation/repeated-prisoners-dilemma/ppo-study.md` in `human-cooperation-site`
